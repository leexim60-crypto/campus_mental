...
_SCALE_INFO: dict[str, dict[str, str]] = {
    ...
    "PSS-10": {
        "desc": "PSS-10 知觉压力量表，共 10 题，评估过去一个月中感受到的压力程度。其中第 4、5、7、9 题为正向题（感知到可控），需反向理解。评分 0-3：从不/偶尔/有时/经常。",
    ...
    "SES": {
        "desc": "Rosenberg 自尊量表（SES），共 10 题，评估个体对自我的整体态度与价值感。其中第 3、5、8、9、10 题为反向题（负向表述）。评分 0-3：非常不同意/不同意/同意/非常同意。",
